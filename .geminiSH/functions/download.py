"""
This module provides functionality to download content from a given URL 
    ...
    try:
        ...
        if mime_type and mime_type in supported_mime_types:
            dest_path = os.path.join(
                os.path.dirname(os.path.abspath(__file__)), "..", "cache", filename
            )
